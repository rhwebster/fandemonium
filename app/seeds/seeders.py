...
teams = [yankees = Team(name='New York Yankees', logo='./logos/nyy.png', abbr='NYY', season_wins=0, season_losses=0, championships=27, background='./team_backgrounds/yankees.jpg', rival=red_sox, stadium=nyy, division=ale),
         red_sox = Team(name='Boston Red Sox', logo='./logos/bos.jpg', abbr='BOS', season_wins=0, season_losses=0, championships=9, background='./team_backgrounds/red_sox.jpg', rival=yankees, stadium=bos, division=ale),
         blue_jays = Team(name='Toronto Blue Jays', logo='./logos/tor.jpg', abbr='TOR', season_wins=0, season_losses=0, championships=2, background='./team_backgrounds/blue_jays.jpg', rival=yankees, stadium=tor, division=ale),
         orioles = Team(name='Baltimore Orioles', logo='./logos/bal.jpg', abbr='BAL', season_wins=0, season_losses=0, championships=3, background='./team_backgrounds/orioles.jpg', rival=nationals, stadium=bal, division=ale),
         rays = Team(name='Tampa Bay Rays', logo='./logos/tbr.png', abbr='TB', season_wins=0, season_losses=0, championships=0, background='./team_backgrounds/rays.jpg', rival=yankees, stadium=tbr, division=ale),
         indians = Team(name='Cleveland Indians', logo='./logos/cle.jpg', abbr='CLE', season_wins=0, season_losses=0, championships=2, background='./team_backgrounds/indians.jpg', rival=tigers, stadium=cle, division=alc),
         tigers = Team(name='Detroit Tigers', logo='./logos/det.jpg', abbr='DET', season_wins=0, season_losses=0, championships=4, background='./team_backgrounds/tigers.jpg', rival=indians, stadium=det, division=alc),
         white_sox = Team(name='Chicago White Sox', logo='./logos/cws.jpg', abbr='CWS', season_wins=0, season_losses=0, championships=3, background='./team_backgrounds/indians.jpg', rival=cubs, stadium=cws, division=alc),
         royals = Team(name='Kansas City Royals', logo='./logos/kcr.png', abbr='KC', season_wins=0, season_losses=0, championships=2, background='./team_backgrounds/royals.jpg', rival=cardinals, stadium=kcr, division=alc),
         twins = Team(name='Minnesota Twins', logo='./logos/min.png', abbr='MIN', season_wins=0, season_losses=0, championships=2, background='./team_backgrounds/twins.jpeg', rival=indians, stadium=mnt, division=alc),
         angels = Team(name='Los Angeles Angels', logo='./logos/laa.jpg', abbr='LAA', season_wins=0, season_losses=0, championships=1, background='./team_backgrounds/angels.jpg', rival=dodgers, stadium=laa, division=alw),
         athletics = Team(name='Oakland Athletics', logo='./logos/oak.jpg', abbr='OAK', season_wins=0, season_losses=0, championships=4, background='./team_backgrounds/as.jpg', rival=giants, stadium=oak, division=alw),
         mariners = Team(name='Seattle Mariners', logo='./logos/sea.jpg', abbr='SEA', season_wins=0, season_losses=0, championships=0, background='./team_backgrounds/mariners.jpg', rival=athletics, stadium=sea, division=alw),
         rangers = Team(name='Texas Rangers', logo='./logos/tex.png', abbr='TEX', season_wins=0, season_losses=0, championships=0, background='./team_backgrounds/rangers.jpg', rival=astros, stadium=tex, division=alw),
         astros = Team(name='Houston Astros', logo='./logos/hou.jpg', abbr='HOU', season_wins=0, season_losses=0, championships=1, background='./team_backgrounds/astros.jpg', rival=rangers, stadium=hou, division=alw),
         mets = Team(name='New York Mets', logo='./logos/nym.png', abbr='NYM', season_wins=0, season_losses=0, championships=2, background='./team_backgrounds/mets.jpg', rival=phillies, stadium=nym, division=nle),
         phillies = Team(name='Philadelphia Phillies', logo='./logos/phi.jpg', abbr='PHI', season_wins=0, season_losses=0, championships=2, background='./team_backgrounds/phillies.jpg', rival=mets, stadium=phi, division=nle),
         nationals = Team(name='Washington Nationals', logo='./logos/was.jpg', abbr='WAS', season_wins=0, season_losses=0, championships=1, background='./team_backgrounds/nationals.jpg', rival=braves, stadium=was, division=nle),
         braves = Team(name='Atlanta Braves', logo='./logos/atl.jpg', abbr='ATL', season_wins=0, season_losses=0, championships=1, background='./team_backgrounds/braves.jpeg', rival=nationals, stadium=atl, division=nle),
         marlins = Team(name='Miami Marlins', logo='./logos/mia.jpg', abbr='MIA', season_wins=0, season_losses=0, championships=2, background='./team_backgrounds/marlins.jpg', rival=rays, stadium=mia, division=nle),
         reds = Team(name='Cincinatti Reds', logo='./logos/cin.jpg', abbr='CIN', season_wins=0, season_losses=0, championships=5, background='./team_backgrounds/reds.jpg', rival=pirates, stadium=cin, division=nlc),
         pirates = Team(name='Pittsburgh Pirates', logo='./logos/pit.jpg', abbr='PIT', season_wins=0, season_losses=0, championships=5, background='./team_backgrounds/pirates.jpg', rival=reds, stadium=pit, division=nlc),
         cubs = Team(name='Chicago Cubs', logo='./logos/chc.png', abbr='CHC', season_wins=0, season_losses=0, championships=3, background='./team_backgrounds/cubs.jpg', rival=cardinals, stadium=chc, division=nlc),
         cardinals = Team(name='St Louis Cardinals', logo='./logos/stl.jpg', abbr='STL', season_wins=0, season_losses=0, championships=11, background='./team_backgrounds/cardinals.jpg', rival=cubs, stadium=stl, division=nlc),
         brewers = Team(name='Milwaukee Brewers', logo='./logos/mil.jpg', abbr='MIL', season_wins=0, season_losses=0, championships=0, background='./team_backgrounds/brewers.jpg', rival=cubs, stadium=mil, division=nlc),
         rockies = Team(name='Colorado Rockies', logo='./logos/col.jpg', abbr='COL', season_wins=0, season_losses=0, championships=0, background='./team_backgrounds/rockies.jpg', rival=diamondbacks, stadium=col, division=nlw),
         diamondbacks = Team(name='Arizona Diamondbacks', logo='./logos/ari.jpg', abbr='ARI', season_wins=0, season_losses=0, championships=1, background='./team_backgrounds/diamondbacks.jpg', rival=rockies, stadium=ari, division=nlw),
         padres = Team(name='San Diego Padres', logo='./logos/sdp.png', abbr='SD', season_wins=0, season_losses=0, championships=0, background='./team_backgrounds/padres.jpg', rival=dodgers, stadium=sdp, division=nlw),
         dodgers = Team(name='Los Angeles Dodgers', logo='./logos/lad.jpg', abbr='LAD', season_wins=0, season_losses=0, championships=6, background='./team_backgrounds/dodgers.jpg', rival=giants, tadium=lad, division=nlw),
         giants = Team(name='San Francisco Giants', logo='./logos/sfg.jpg', abbr='SF', season_wins=0, season_losses=0, championships=3, background='./team_backgrounds/giants.jpg', rival=dodgers, stadium=sfg, division=nlw)
]
