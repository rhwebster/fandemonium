...
padres = Team(name='San Diego Padres', logo='.https://fandemoniumpics.s3.us-east-2.amazonaws.com/logos/sdp.png', abbr='SD', season_wins=0, season_losses=0, championships=0, background='https://fandemoniumpics.s3.us-east-2.amazonaws.com/team_backgrounds/padres.jpg', stadium=sdp, division=nlw, twitter='Pades')
